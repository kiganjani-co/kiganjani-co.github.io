...
const en: Copy = {
  ...
  stats: [
    ...
    { value: "10", unit: "days", label: "structured process from brief to launch", icon: "clock" },
...
const sw: Copy = {
  ...
  process: {
    ...
    h1: "Siku 10 —",
    h1em: "kutoka mwanzo hadi uzinduzi.",
    steps: [
  ...
  stats: [
    ...
    { value: "10", unit: "siku", label: "mchakato uliopangwa kutoka muhtasari hadi uzinduzi", icon: "clock" },
